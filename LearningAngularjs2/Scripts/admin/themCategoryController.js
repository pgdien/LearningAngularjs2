myApp.controller("themCategoryController", ['$scope', '$http', '$window', '$location', '$filter', 'Alias', 'MenuMultiLevel', 'Url', function ($scope, $http, $window, $location, $filter, Alias, MenuMultiLevel, Url) {
    $scope.Category = {};
    $scope.categoryParents = [];
    $scope.categoryParent = {};

    //Lấy idCategory từ đường dẫn
